...
Ten dokument to szczegółowa mapa drogowa rozwoju projektu.
...
- [ ] **R.1**: **Zbudowanie pierwszych testowych talii do gry.** Zadanie polega na wybraniu zestawu kart (na podstawie bazy JSON z Fazy 1.1), które stworzą zbalansowane talie początkowe. 
  > ⏳ **Oś czasu:** Talie te będą krytycznie potrzebne najpóźniej przed rozpoczęciem **Fazy 4** (Serce Gry i Maszyna Stanów). Aby programiści mieli na czym testować logikę gry na stole, listy kart wchodzących w skład talii testowych muszą być gotowe najpóźniej na zakończenie Fazy 3.
